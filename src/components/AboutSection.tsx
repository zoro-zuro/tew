...
const AboutSection: React.FC = memo(() => {
    ...
    return (
        <section id="about" ref={sectionRef} className="relative bg-white pt-[30px] sm:pt-[64px]">
            {/* Stats Bar Component */}
            <div className="max-w-[1050px] mx-auto -translate-y-1/2 sm:-translate-y-1/2 relative z-30 px-6 sm:px-6 ">
                <div className="relative bg-gradient-to-b from-brand/25 via-brand/5 to-transparent backdrop-blur-sm rounded-[1.5rem] sm:rounded-[2rem] overflow-hidden mt-[30px] sm:mt-[64px]">
                    {/* Border decorations */}
            ...
            <div className=" md:px-[94px]">
                <div className="flex flex-col md:flex-row items-center justify-between gap-[60px] w-full">
                    <div className="w-full pt-2 sm:pt-4 md:min-w-[675px]">
                        ...
                        <h2 className="font-montserrat text-[14px] sm:text-[32px] font-bold text-[#1A1A1A] leading-[1.3] tracking-tight mb-[8px]" style={{ lineHeight: "140%" }}>
                            Your Reliable OEM Manufacturing Partner
                        </h2>

                        <div className=" font-poppins space-y-3 sm:space-y-[12px] text-justified text-[#2e2e2e]/60 font-medium leading-relaxed max-w-[700px] text-[10px] sm:text-[16px] mb-[30px] sm:mb-[54px]" style={{ lineHeight: "170%", letterSpacing: "2%" }}>
                    ...
                    <div className="block  w-full h-[200px] sm:h-[420px] relative mt-8 sm:mt-0">
                        ...
                        <div
                            className="absolute -top-[30px] sm:-top-[78px] -right-[20px] sm:-right-[70px] rotate-[10deg] z-20 w-28  sm:w-48 h-28 sm:h-48 hidden sm:block"
                        >
                        ...
                        <div className="absolute w-fit top-2 sm:top-[45px] -left-4 sm:-left-9 bg-white px-3 sm:pl-4 sm:pr-0 py-2 sm:py-3 rounded-[32px] hover:rounded-[18px] shadow-lg flex flex-col items-start border border-gray-100 z-20 transition-all duration-500 overflow-hidden group">
                            <div className="flex items-center gap-2 sm:gap-3 whitespace-nowrap">
                                <svg width="33" height="36" viewBox="0 0 33 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                            ...
                            <div className="max-h-0 group-hover:max-h-[100px] transition-all duration-500 ease-in-out opacity-0 group-hover:opacity-100">
                                <p className="text-[9px] sm:text-[12px] font-medium text-black/80 mt-2 leading-tight w-32">
                        ...
                        <div className="absolute w-fit top-[260px] sm:top-[380px] -right-2 bg-white px-3 sm:pl-4 sm:pr-2 py-2 sm:py-3 rounded-[32px] hover:rounded-[18px] shadow-lg flex flex-col items-start border border-gray-100 z-20 transition-all duration-500 overflow-hidden group">
                            <div className="flex items-center gap-2 sm:gap-3 whitespace-nowrap">
                                <div className="w-8 sm:w-10 h-8 sm:h-10 flex items-center justify-center shrink-0">
                            ...
                            <div className="max-h-0 group-hover:max-h-[100px] transition-all duration-500 ease-in-out opacity-0 group-hover:opacity-100 w-full">
                                <p className="text-[9px] sm:text-[12px] font-medium text-black/80 mt-2 leading-tight whitespace-normal w-[120px]">
